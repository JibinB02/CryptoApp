...
const CryptoDetails = () => {
  ...
  const stats = [
    ...
    { title: 'Website', value: `${cryptoDetails.websiteUrl && cryptoDetails.websiteUrl}`, icon: <ThunderboltOutlined /> },
      ...
      <Col className='coin-detail-container'>
          ...
          <Col className='coin-desc-link'>
            <Row className='coin-desc'>
              ...
              <Title level={3}>{HTMLReactParser(cryptoDetails.description)}</Title>
            </Row>
